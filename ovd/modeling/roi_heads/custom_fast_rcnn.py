...
class CustomFastRCNNOutputLayers(FastRCNNOutputLayers):
    ...
    def __init__(
        ...
        self.loss_weight_region_to_image = loss_weight_region_to_image
    ...
    def from_config(cls, cfg, input_shape):
        ...
        ret.update({
            ...
            'loss_weight_region_to_image': cfg.DDPM.LOSS_WEIGHT_REGION_TO_IMAGE,
        })
    ...
    # def get_obj_to_txt_loss(self, region_feats, proposals):
    ...
    def distil_l1_loss(self, image_features, clip_features):
        ...
        # loss = F.mse_loss(image_features, clip_features, reduction='mean')
        loss = loss * weight
        return loss
    ...
    def sigmoid_cross_entropy_loss(self, pred_class_logits, gt_classes):
        ...
        obj_to_txt_dis_loss = F.binary_cross_entropy_with_logits(
            pred_class_logits[:, :-1], target, reduction='none')
        loss = torch.sum(obj_to_txt_dis_loss * weight) / B
        return loss
    ...
    def inference(self, predictions, proposals):
        ...
        # scores = self.predict_probs_dis(predictions, proposals)
        ...
        loss_dict.update(
            {
                ...
                'obj_to_txt_dis_loss': score.new_zeros([1])[0],
